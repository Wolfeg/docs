...
1. [Get the ID of any folder](../../resource-manager/operations/folder/get-id.md) for which your account has the `{{ roles-translate-user }}` [role](../../translate/security/index.md) or higher. Make sure to include the folder ID in the `folderId` field in the body of each request.
