...
- {{ TF }} {#tf}
    ...
    1. Измените в описании кластера {{ GP }} значение атрибута `description`:
...
- {{ TF }} {#tf}
    ...
    1. Измените в описании кластера {{ GP }} значения нужных дополнительных настроек:
...
- {{ TF }} {#tf}
    ...
    1. Измените в описании кластера {{ GP }} значение атрибута `service_account_id`:
...
- {{ TF }} {#tf}
    ...
    1. Измените в описании кластера {{ GP }} значения атрибутов в блоке `logging`:
